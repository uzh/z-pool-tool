        ...
        try {
            ...
            new Calendar(el, {
                ...
                eventDidMount: function (info) {
                    [...info.el.querySelectorAll('.fc-list-event-title')].map(x => { const span = document.createElement('span'); span.textContent = info.event.extendedProps.location.name; x.appendChild(span); });
                    tippy(info.el, {
                        arrow: false,
                        appendTo: el,
