(* Extracted from the Sihl web framework (https://github.com/oxidizing/sihl), MIT license.
   Source:
   https://github.com/uzh/sihl/blob/6c3c4040413294155cda3a363edf0ff3c7e638b8/sihl/src/web.ml
   The unused [style] constant has been removed. *)
...
let externalize_path ?prefix path =
  let prefix =
    match prefix, Pool_core.Configuration.read_string "PREFIX_PATH" with
