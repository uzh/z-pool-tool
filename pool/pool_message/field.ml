...
type t =
  ...
  | Channel [@name "channel"] [@printer go "channel"]
  ...
  | ProfileOnly [@name "profile_only"] [@printer go "profile_only"]
  ...
  | SmtpInternalRegex [@name "smtp_internal_regex"] [@printer go "smtp_internal_regex"]
  | SmtpInvitationCapacity [@name "smtp_invitation_capacity"]
  [@printer go "smtp_invitation_capacity"]
  ...
  | SmtpRateLimit [@name "smtp_rate_limit"] [@printer go "smtp_rate_limit"]
  | SmtpServer [@name "smtp_server"] [@printer go "smtp_server"]
  | SmtpSystemAccount [@name "smtp_system_account"] [@printer go "smtp_system_account"]
