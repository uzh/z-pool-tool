...
type t =
  ...
  | PendingContactImports [@name "pending_contact_imports"] [@printer go "pending_contact_imports"]
  ...
  | PromptOnRegistration [@name "prompt_on_registration"] [@printer go "prompt_on_registration"]
