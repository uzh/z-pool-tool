...
let steps =
  let sorted =
    ...
    @ [ Migration_202301010000.migration ()
      ...
      ; Migration_202503130858.migration ()
      ; Migration_202503201246.migration ()
      ; Migration_202503251234.migration ()
      ; Migration_202504090754.migration ()
      ; Migration_202504111642.migration ()
      ; Migration_202505121331.migration ()
      ; Migration_202506261422.migration ()
      ; Migration_202508141040.migration ()
      ; Migration_202603061300.migration ()
      ; Migration_202603131200.migration ()
      ; Migration_202604130000.migration ()
      ; Migration_202604170000.migration ()
      ; Migration_202604180000.migration ()
      ; Migration_202604200000.migration ()
      ; Migration_202605110000.migration ()
      ; Migration_202605291200.migration ()
      ; Migration_202606170000.migration ()
      ; Migration_202607031200.migration ()
