...
module Field = struct
  ...
  type t =
    ...
    | AllowUninvitedSignup
        [@name "allow_uninvited_signup"] [@printer go "allow_uninvited_signup"]
    ...
    | CustomFieldGroup
        [@name "custom_field_group"] [@printer go "custom_field_group"]
    | CustomFieldGroups
        [@name "custom_field_groups"] [@printer go "custom_field_groups"]
    | CustomFieldOption
        [@name "custom_field_option"] [@printer go "custom_field_option"]
    | CustomFieldOptions
        [@name "custom_field_options"] [@printer go "custom_field_options"]
    | CustomHtmx of (string * string)
        [@name "custom"] [@printer custom "custom"]
    ...
    | DistributionField
        [@name "distribution_field"] [@printer go "distribution_field"]
    ...
    | InvitationCount
        [@name "invitation_count"] [@printer go "invitation_count"]
    | InvitationSubject
        [@name "invitation_subject"] [@printer go "invitation_subject"]
    ...
    | ReminderSubject
        [@name "reminder_subject"] [@printer go "reminder_subject"]
    ...
    | TriggerProfileUpdateAfter
        [@name "trigger_profile_update_after"]
