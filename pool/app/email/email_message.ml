(* Extracted from the Sihl web framework (https://github.com/oxidizing/sihl), MIT license.
   This is the email type of the former [Sihl_email] / [Sihl.Contract.Email] module.
   Source:
   https://github.com/uzh/sihl/blob/6c3c4040413294155cda3a363edf0ff3c7e638b8/sihl/src/contract_email.ml
   The service signature and the unused [set_html] function have been removed. *)
