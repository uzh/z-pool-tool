...
val token : unverified t -> Pool_token.t
...
val create : Pool_user.EmailAddress.t -> Pool_user.t -> Pool_token.t -> unverified t
...
val create_token : Database.Label.t -> Pool_user.EmailAddress.t -> Pool_token.t Lwt.t
